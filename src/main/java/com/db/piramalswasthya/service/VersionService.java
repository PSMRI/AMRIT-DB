...
public class VersionService {
	...
	public VersionService(@Qualifier("dbiemrJdbcTemplate") JdbcTemplate jdbcTemplate) {
		this.dbiemrJdbcTemplate = jdbcTemplate;
	}

	public List<FlywaySchemaVersion> getLatestVersion() {
		String sql = "SELECT * FROM flyway_schema_history order by 1 desc limit 1";
		return dbiemrJdbcTemplate.query(sql, new RowMapper<FlywaySchemaVersion>() {
			@Override
